  ...
  generate(builder, output3) {
    ...
    if (output3 !== "void") {
      ...
      if (op === "==") {
        if (isGLSL) {
          if (outputLength > 1) {
            return builder.format(`${builder.getMethod("equal", output3)}( ${a}, ${b} )`, type, output3);
          } else {
          ...
          if (outputLength > 1 || !builder.isVector(typeA)) {
            ...
            return builder.format(`all( ${a} == ${b} )`, type, output3);
          }
        }
        ...
        if (builder.isInteger(typeB)) {
          ...
          return builder.format(`${builder.getMethod("mod", type)}( ${a}, ${b} )`, type, output3);
        }
      } else if (op === "!" || op === "~") {
